...
# Global heat transfer coefficient referenced to the inner radius, in cylindrical geometry
U_1c = 1 / (
    1 / h_1
...
# Global heat transfer coefficient referenced to the vessel-insulator interface radius, in cylindrical geometry
U_2c = 1 / (
