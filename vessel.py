...
print(f"Design temperature: {T_shield_avg - Kelvin} C")
print(f"Minimum shield temperature: {T_shield_min} C")
print(f"Maximum shield temperature: {T_shield_max} C")
...
def integrand_function(rho):
    x_local = rho - a
    return Temperature_profile(x_local) * rho
...
for i in range(len(r)):
    ...
    Temp_val = Temperature_profile(radius - a)
